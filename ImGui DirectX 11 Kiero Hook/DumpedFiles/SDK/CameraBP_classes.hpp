...
public:
	...
	uint8                                         Pad_217C[0x3];                                     // 0x02E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_217D[0x3];                                     // 0x02F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_217E[0x1];                                     // 0x0307(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_217F[0x3];                                     // 0x0341(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void CamDestroyed__DelegateSignature(const struct FVector& Location, class ACameraBP_C* Param_Camera);
	...
	void DestroyCamera();
	void BndEvt__CameraBP_DamageComponent_K2Node_ComponentBoundEvent_1_Damage__DelegateSignature(int32 Amount, class FName Bone, const struct FVector& HitLocation, const struct FVector& StartLocation, class AActor* Param_Instigator);
	void CameraCheck();
	...
	void FindNextCam(int32 SwitchNum, int32 Param_CamNumber, class ACameraBP_C** Param_Camera);
