...
// Parameters:
// struct FVector                          Location                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ACameraBP_C*                      Param_Camera                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ACameraBP_C::CamDestroyed__DelegateSignature(const struct FVector& Location, class ACameraBP_C* Param_Camera)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Location = std::move(Location);
	Parms.Param_Camera = Param_Camera;
...
void ACameraBP_C::BndEvt__CameraBP_DamageComponent_K2Node_ComponentBoundEvent_1_Damage__DelegateSignature(int32 Amount, class FName Bone, const struct FVector& HitLocation, const struct FVector& StartLocation, class AActor* Param_Instigator)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32                                   SwitchNum                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Param_CamNumber                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ACameraBP_C*                      Param_Camera                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ACameraBP_C::FindNextCam(int32 SwitchNum, int32 Param_CamNumber, class ACameraBP_C** Param_Camera)
{
	static class UFunction* Func = nullptr;
	...
	Parms.SwitchNum = SwitchNum;
	Parms.Param_CamNumber = Param_CamNumber;
