...
public:
	...
	uint8                                         Pad_1594[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	float                                         Param_Accuracy;                                    // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Param_Capacity;                                    // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         Param_Firerate;                                    // 0x000C(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Param_Recoil;                                      // 0x0010(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Param_ReloadTime;                                  // 0x0014(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(GunInfoPanel_C_CompareStats, Param_Accuracy) == 0x000000, "Member 'GunInfoPanel_C_CompareStats::Param_Accuracy' has a wrong offset!");
static_assert(offsetof(GunInfoPanel_C_CompareStats, Param_Capacity) == 0x000004, "Member 'GunInfoPanel_C_CompareStats::Param_Capacity' has a wrong offset!");
static_assert(offsetof(GunInfoPanel_C_CompareStats, Param_Damage) == 0x000008, "Member 'GunInfoPanel_C_CompareStats::Param_Damage' has a wrong offset!");
static_assert(offsetof(GunInfoPanel_C_CompareStats, Param_Firerate) == 0x00000C, "Member 'GunInfoPanel_C_CompareStats::Param_Firerate' has a wrong offset!");
static_assert(offsetof(GunInfoPanel_C_CompareStats, Param_Recoil) == 0x000010, "Member 'GunInfoPanel_C_CompareStats::Param_Recoil' has a wrong offset!");
static_assert(offsetof(GunInfoPanel_C_CompareStats, Param_ReloadTime) == 0x000014, "Member 'GunInfoPanel_C_CompareStats::Param_ReloadTime' has a wrong offset!");
