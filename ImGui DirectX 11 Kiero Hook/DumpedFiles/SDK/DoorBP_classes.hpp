...
public:
	...
	void ChangeDoorMesh();
	void UnlockDoor();
	void BndEvt__DoorBP_DamageComponent_K2Node_ComponentBoundEvent_5_Damage__DelegateSignature(int32 Amount, class FName Bone, const struct FVector& HitLocation, const struct FVector& StartLocation, class AActor* Param_Instigator);
	...
	void OpenDoorMulti(class AActor* Player, float OpenSpeed, bool Param_Open_, bool Sneaking_, bool Ease_);
