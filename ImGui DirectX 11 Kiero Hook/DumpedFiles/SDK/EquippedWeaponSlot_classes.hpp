...
public:
	...
	uint8                                         Pad_1DA1[0x3];                                     // 0x02A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DA2[0x4];                                     // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void CancelDrag();
	void DragItemFromCategory(EShopItemCategory Param_Category);
	void Remove();
	...
	void ChangeCategory(EShopItemCategory Param_Category);
