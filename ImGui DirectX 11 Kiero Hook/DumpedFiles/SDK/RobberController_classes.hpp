...
public:
	...
	void ApplySettings();
	void SaveSettings();
	void UpdateVotes(class ARobberController_C* Param_Player);
	void VoteRestart(class ARobberController_C* Param_Player);
	void SetToolsServer(const TArray<class UClass*>& Tools);
	void UpdateMessages(const class FString& Param_ChatLog, const class FString& NameLog);
	void ChatMessageController(const class FString& Message, const class FString& Param_Name);
	...
	void LoadAppearance();
	void SaveAppearance();
	void UpdateAppearance(const TArray<class UClass*>& Masks, const TArray<class UClass*>& Outfits, const TArray<class UClass*>& Emote, const TArray<class UClass*>& Armor, class UMaterialInterface* Param_SkinColor);
	void LoadWeapons();
	void SaveWeapons();
	void LoadAll();
	...
	void Find_Equipped_Item_from_Category_Function(EShopItemCategory Category, int32 Param_Index, class UClass** Item);
	void OverrideIndexFromCategory(EShopItemCategory Category, int32 Param_Index, class UClass* Item);
	void RemoveInventoryItem(class UClass* Item, bool* Success_);
	void AddInventoryItem(class UClass* Item, int32* Param_Index);
	void GetInventoryItemsInCategory(EShopItemCategory Category, bool Include_equipped_, TArray<class UClass*>* Inventory);
	void UpdateNewWeapon(int32 Param_Index);
	...
	void FindEquppedAttachmentFunc(EShopItemCategory Category, int32 Param_Index, class UClass** Attachment);
	...
	void GetRequiredEXP(int32 Param_Level, float* EXP_required_for_levelup);
	void GetEXPForLevel(int32 Param_Level, float* Param_Exp);
