...
public:
	void PowerSet__DelegateSignature(int32 Total, int32 Minimum, float Param_PowerMultiplier);
	void ExecuteUbergraph_RobberGameState(int32 EntryPoint);
	void SetFirepower();
	void ReceiveBeginPlay();
	void SpawnToolsWhenConnected();
	void GetTotalPlayerPower(int32* Param_Total_power, int32* Param_MinimumPower);
