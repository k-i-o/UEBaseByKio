...
public:
	...
	uint8                                         Pad_15FC[0x3];                                     // 0x02B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ActivateC4();
	void BndEvt__C4_PickupItemComponent_K2Node_ComponentBoundEvent_3_InteractHolding__DelegateSignature(class AActor* Param_Instigator, class AActor* Overlap);
	void Explode();
	void BndEvt__C4_DamageComponent_K2Node_ComponentBoundEvent_2_Damage__DelegateSignature(int32 Amount, class FName Bone, const struct FVector& HitLocation, const struct FVector& StartLocation, class AActor* Param_Instigator);
