...
{
public:
	uint8                                         Pad_CBE[0x38];                                     // 0x0030(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_CC1[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_CC8[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_CDA[0x1E0];                                    // 0x0158(0x01E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class USteamCoreFriendsAsyncActionSetPersonaName* SetPersonaNameAsync(class UObject* WorldContextObject, const class FString& Param_Name, float Timeout);
...
public:
	FMulticastInlineDelegateProperty_             OnCallback;                                        // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D16[0x30];                                     // 0x0048(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D18[0xE0];                                     // 0x00D8(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D23[0xA0];                                     // 0x00B8(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D29[0x20];                                     // 0x0078(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool Init();
	void SetLEDColor(const struct FInputHandle& Handle, uint8 ColorR, uint8 ColorG, uint8 ColorB, ESteamCoreInputLEDFlag Param_Flags);
	...
	void TriggerRepeatedHapticPulse(const struct FInputHandle& Handle, ESteamCoreControllerPad TargetPad, uint8 DurationMicroSec, uint8 OffMicroSec, uint8 Repeat, uint8 Param_Flags);
...
public:
	...
	uint8                                         Pad_D46[0xC0];                                     // 0x00C8(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D74[0x120];                                    // 0x00F8(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_D9A[0xE8];                                     // 0x0058(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnCallback;                                        // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9D[0x90];                                     // 0x0048(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9F[0x20];                                     // 0x0058(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnCallback;                                        // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_DA2[0x20];                                     // 0x0048(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_DB5[0x10];                                     // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DB6[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DB7[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DC7[0xC0];                                     // 0x00C8(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DD6[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DDC[0x80];                                     // 0x00A8(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DF3[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_DFE[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E5E[0x160];                                    // 0x0118(0x0160)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_E6C[0xA0];                                     // 0x00B8(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_ECF[0xA0];                                     // 0x00B8(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_ED7[0x40];                                     // 0x0088(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
