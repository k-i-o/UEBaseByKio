...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04ADBA50;
	constexpr int32 AppendString      = 0x00FD6520;
	constexpr int32 GNames            = 0x04A9F700;
	constexpr int32 GWorld            = 0x04C233F0;
	constexpr int32 ProcessEvent      = 0x011C6A90;
