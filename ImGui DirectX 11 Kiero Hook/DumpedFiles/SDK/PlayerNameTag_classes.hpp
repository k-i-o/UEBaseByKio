...
public:
	...
	class FString                                 Name_PlayerNameTag_C;                              // 0x0290(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UPlayerNameTag_C, Name_PlayerNameTag_C) == 0x000290, "Member 'UPlayerNameTag_C::Name_PlayerNameTag_C' has a wrong offset!");
