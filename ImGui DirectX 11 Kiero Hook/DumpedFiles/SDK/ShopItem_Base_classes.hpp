...
public:
	...
	class FString                                 Name_ShopItem_Base_C;                              // 0x0228(0x0010)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(offsetof(AShopItem_Base_C, Name_ShopItem_Base_C) == 0x000228, "Member 'AShopItem_Base_C::Name_ShopItem_Base_C' has a wrong offset!");
