...
void UWebLeaderboards::DeleteLeaderboard(const TDelegate<void(const class FString& Data, bool bWasSuccessful)>& Callback, const class FString& Key, int32 AppID, const class FString& Param_Name)
{
	static class UFunction* Func = nullptr;
...
void UWebLeaderboards::FindOrCreateLeaderboard(const TDelegate<void(const class FString& Data, bool bWasSuccessful)>& Callback, const class FString& Key, int32 AppID, const class FString& Param_Name, const class FString& SortMethod, const class FString& DisplayType, bool bCreateIfNotFound, bool bOnlyTrustedWrites, bool bOnlyFriendsReads)
{
	static class UFunction* Func = nullptr;
...
class USteamCoreWebAsyncActionDeleteLeaderboard* USteamCoreWebAsyncActionDeleteLeaderboard::DeleteLeaderboardAsync(class UObject* WorldContextObject, const class FString& Key, int32 AppID, const class FString& Param_Name)
{
	static class UFunction* Func = nullptr;
