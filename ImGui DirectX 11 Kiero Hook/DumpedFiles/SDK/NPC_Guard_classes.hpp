...
public:
	...
	void BndEvt__NPC_Guard_PawnSensing_K2Node_ComponentBoundEvent_2_HearNoiseDelegate__DelegateSignature(class APawn* Param_Instigator, const struct FVector& Location, float Volume);
	...
	void ShootShock(class AActor* Param_Instigator);
	void BndEvt__NPC_Guard_DamageComponent_K2Node_ComponentBoundEvent_1_Damage__DelegateSignature(int32 Amount, class FName Bone, const struct FVector& HitLocation, const struct FVector& StartLocation, class AActor* Param_Instigator);
	void Shoot();
	void MoveToTarget();
	void FindTarget();
