...
// Parameters:
// struct FAttachmentArrayStructure        Param_Attachments                                      (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)

void AGunBase_C::SetupAttachmentsMulti(const struct FAttachmentArrayStructure& Param_Attachments)
{
	static class UFunction* Func = nullptr;
...
// float                                   Param_Accuracy                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   Param_Reload_time                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   Param_Damage                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Bullets                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGunBase_C::Get_Any_Gun_Stats(const struct FAttachmentArrayStructure& AttachmentArrayStructure, class UClass* GunClass, float* Zoom, float* Recoil, float* Param_Accuracy, float* Param_Reload_time, float* Param_Damage, int32* Bullets)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Accuracy != nullptr)
		*Param_Accuracy = Parms.Param_Accuracy;

	if (Param_Reload_time != nullptr)
		*Param_Reload_time = Parms.Param_Reload_time;

	if (Param_Damage != nullptr)
		*Param_Damage = Parms.Param_Damage;
...
void AGunBase_C::GetThisGunStats(float* Zoom, float* Recoil, float* Param_Accuracy, float* Param_Reload_time, float* Param_Damage, int32* Bullets)
{
	static class UFunction* Func = nullptr;
...
// class UClass*                           Param_Class                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGunBase_C::GetAttachmentFromCategory(EShopItemCategory Category, class UClass** Param_Class)
{
	static class UFunction* Func = nullptr;
...
void AGunBase_C::GetUpgradeStats(class UClass* Upgrade, float* Recoil, float* Param_Accuracy, float* Param_Damage, int32* Bullets, float* Param_Reload_time)
{
	static class UFunction* Func = nullptr;
