...
public:
	...
	void HostGame(class FName Param_Map);
	void NewChat();
	void OnSuccess_A110421C4837192EE5791EA86298FC0A(const TArray<struct FBlueprintSessionResult>& Param_Results);
	void OnFailure_A110421C4837192EE5791EA86298FC0A(const TArray<struct FBlueprintSessionResult>& Param_Results);
	...
	void OnSuccess_40CC732343607C4A3B0198893B9834D6(const TArray<struct FBPFriendInfo>& Param_Results);
	void OnFailure_40CC732343607C4A3B0198893B9834D6(const TArray<struct FBPFriendInfo>& Param_Results);
