...
void APoliceWaveSpawner_C::SetPower(int32 Total, int32 Minimum, float Param_PowerMultiplier)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// float                                   Param_WaveMultiplier                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void APoliceWaveSpawner_C::DecideWaveSize(float Param_WaveMultiplier)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_WaveMultiplier = Param_WaveMultiplier;
