...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FString                           Param_InteractDescription                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void APlayerCharacter_C::SetInteractDescriptionInterfaceCall(const class FString& Param_InteractDescription)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_InteractDescription = std::move(Param_InteractDescription);
...
void APlayerCharacter_C::BndEvt__PlayerCharacter_DamageComponent_K2Node_ComponentBoundEvent_1_Damage__DelegateSignature(int32 Amount, class FName Bone, const struct FVector& HitLocation, const struct FVector& StartLocation, class AActor* Param_Instigator)
{
	static class UFunction* Func = nullptr;
...
void APlayerCharacter_C::TakeDamage(int32 Damage, const struct FVector& AttackerLocation, bool Indicate_direction_, class AActor* Param_Instigator)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_Downed_                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void APlayerCharacter_C::CheckIfDowned_(bool* Param_Downed_)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Downed_ != nullptr)
		*Param_Downed_ = Parms.Param_Downed_;
}
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                           Param_HoldingActor                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void APlayerCharacter_C::GetHoldingActor(class AActor** Param_HoldingActor)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_HoldingActor != nullptr)
		*Param_HoldingActor = Parms.Param_HoldingActor;
}
